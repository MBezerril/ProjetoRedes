...
def hammingCodes(data):
    ...
    while i < n:
        ...
        if total % 2 > 0:
            list1[int(
                k) - 1] = 1  # to check even parity summing up all the elements in sublist and if summ is even than even parity else odd parit
...
#print(hammingCodes([1,0,1,1,0,0,1]))
#print(hammingCorrection([1, 0, 1, 0, 0, 1, 1, 1, 0, 0, 1]))